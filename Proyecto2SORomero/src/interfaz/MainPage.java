...
public class MainPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        logoZelda = new javax.swing.JLabel();
        jLabel1 = new javax.swing.JLabel();
        lamboWinsLabel = new javax.swing.JLabel();
        jPanel1 = new javax.swing.JPanel();
        jLabel2 = new javax.swing.JLabel();
        logoSF = new javax.swing.JLabel();
        ...
        zeldaPer = new javax.swing.JLabel();
        sfPer = new javax.swing.JLabel();
        ...
        colaLamboUi1.setBackground(new java.awt.Color(204, 255, 255));
        colaLamboUi1.setForeground(new java.awt.Color(0, 204, 204));
        ...
        jPanel3.setBackground(new java.awt.Color(245, 125, 18));
        jPanel3.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        logoZelda.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/logoZelda.png"))); // NOI18N
        jPanel3.add(logoZelda, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 190, 120));
        ...
        lamboWinsLabel.setForeground(new java.awt.Color(51, 51, 51));
        lamboWinsLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lamboWinsLabel.setText("0");
        jPanel3.add(lamboWinsLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 50, 70, 30));
        ...
        jPanel1.add(logoSF, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 20, 160, 80));

        bgWinsLabel1.setBackground(new java.awt.Color(51, 51, 51));
        bgWinsLabel1.setFont(new java.awt.Font("Segoe UI", 0, 30)); // NOI18N
        bgWinsLabel1.setForeground(new java.awt.Color(51, 51, 51));
        bgWinsLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        bgWinsLabel1.setText("0");
        jPanel1.add(bgWinsLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 50, 70, 30));

        jPanel2.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 30, 340, 600));
        ...
        uiLamboId.setForeground(new java.awt.Color(255, 255, 255));
        uiLamboId.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        racePanel.add(uiLamboId, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, 230, 20));

        uibugattiId.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        uibugattiId.setForeground(new java.awt.Color(255, 255, 255));
        uibugattiId.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        racePanel.add(uibugattiId, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 50, 230, 30));
        ...
        racePanel.add(zeldaPer, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 230, 210));
        racePanel.add(sfPer, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 80, 230, 220));

        lamboWinLabel.setBackground(new java.awt.Color(255, 255, 0));
        lamboWinLabel.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        lamboWinLabel.setForeground(new java.awt.Color(255, 51, 0));
        ...
        bugattiWinLabel.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        bugattiWinLabel.setForeground(new java.awt.Color(255, 0, 0));
        ...
        stage.setBackground(new java.awt.Color(204, 204, 255));
        stage.setText("s");
        ...
        sliderPane.setBackground(new java.awt.Color(204, 102, 0));
        ...
        winnersPane.setBackground(new java.awt.Color(0, 102, 102));
    ...
    private javax.swing.JLabel logoSF;
    private javax.swing.JLabel logoZelda;
    private javax.swing.JPanel racePanel;
    private javax.swing.JLabel sfPer;
    ...
    private javax.swing.JLabel zeldaPer;
    // End of variables declaration//GEN-END:variables

    private void init(){
        setTitulosColas();
        setImageLabel(logoZelda, "src/imgs/logoZelda.png");
        setImageLabel(logoSF, "src/imgs/logoSF.png");
    ...
    public void setCarsImgsUi(){
        ...
        setImageLabel(zeldaPer, ("src/imgs/zelda"+ picLambo + ".png"));
        setImageLabel(sfPer, ("src/imgs/sf" + picBg + ".png"));
    }
